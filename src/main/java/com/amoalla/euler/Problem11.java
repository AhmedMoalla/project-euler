...
/// 67 26 20 68  2 62 12 20    95  <b>63</b> 94     39     63  8 40 91 66 49 94 21
/// 24 55 58  5 66 73 99 26    97     17  <b>78</b> 78     96 83 14 88 34 89 63 72
/// 21 36 23  9 75  0 76 44    20     45     35  <b>14</b>  0 61 33 97 34 31 33 95
...
void main() {
    ...
    for (int y = 0; y < grid.length; y++) {
        for (int x = 0; x < grid[y].length; x++) {
            int up = grid(x, y) * grid(x, y - 1) * grid(x, y - 2) * grid(x, y - 3),
...
int grid(int x, int y) {
    if (x < 0 || y < 0 || y >= grid.length || x >= grid[y].length) return 0;
    return grid[y][x];
}